package algorithm.other;// A Java program for Dijkstra's single source shortest path algorithm.
...
/**
 *  The {@code UF} class represents a <em>union¨Cfind data type</em>
 ...
 *  of sets.
 *  <p>
 *  The union¨Cfind data type models a collection of sets containing
 *  <em>n</em> elements, with each element in exactly one set.
 *  The elements are named 0 through <em>n</em>¨C1.
