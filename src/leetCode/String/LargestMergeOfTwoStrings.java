...
public class LargestMergeOfTwoStrings {
    public static String largestMerge(String word1, String word2) {
        ...
        while (i < l1 || j < l2) {
            ...
            if (i < l1 && j < l2) {
                if (word1.charAt(i) > word2.charAt(j)) {
                    ...
                    int _i = i, _j = j;
                    while (_i < l1 && _j < l2 && word1.charAt(_i) == word2.charAt(_j)) {
                        _i++;
                        _j++;
                    }
                    if ((_i < l1 && _j < l2 && word1.charAt(_i) > word2.charAt(_j)) || (_i < l1 && _j >= l2)) {
        ...
        if (i < l1) {
            sb.append(word1, i, l1);
        }
        if (j < l2) {
            sb.append(word2, j, l2);
        }
        return sb.toString();
    ...
    public static void main(String[] args) {
        System.out.println("largestMerge = " + largestMerge("qqeqeqqeeqqq","qeqqqeeqqeeqqqqqeq"));
    }
}
